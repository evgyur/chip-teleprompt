...
$scrollLabel.Font = New-DefaultTextFont 15 ([System.Drawing.FontStyle]::Regular)
...
$fontSize.Minimum = 14; $fontSize.Maximum = 96; $fontSize.Value = 15; $fontSize.TickFrequency = 10
